...
public class FusionPlayerUIManager : MonoBehaviour
{
    ...
    void DisplayPlayerCondition(FusionPlayer player)
    {
        if (player.GetName() == null)
        {
            return;
    ...
    public void DisplayTurnChangePanel(FusionPlayer turn_player, Situation.PlayingSituation situation, bool active)
    {
    ...
    public void ChangePlayerImage(CharacterType character, bool hope = false, bool despair = false)
    {
        ...
        Image_Player.sprite = TextureToSprite(Resources.Load<Texture2D>(character_info.GetCharacterFile(character, hope, despair)));
    }
