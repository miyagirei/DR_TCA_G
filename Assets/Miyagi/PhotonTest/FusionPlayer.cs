...
{
    [Networked] public NetworkString<_16> _name { get; set; }
    [Networked] public int _max_hp { get; set; }
    [Networked] public int _hp { get; set; }
    [Networked] public NetworkBool _is_current_player { get; set; }
    [Networked] public NetworkBool _is_win { get; set; }
    [Networked] public NetworkBool _is_hope { get; set; }
    [Networked] public NetworkBool _is_despair { get; set; }
    [Networked] public Vector3 _card_pos { get; set; }
    [Networked] public Vector3 _card_scale { get; set; }
    ...
    public void RPC_SetCurrentPlayer(bool value)
    {
